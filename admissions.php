            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="gallery__inner">
                        <img src="images/gallery/big-img/b1.jpg" alt="gallery images">
                        <h2>Admission Process</h2>
                        <p>The admission process for <b>Advaya Shaale</b> begins in the month of <b>September</b> with an open day organised for all interested parents. Herein we explain the broad elements of <b>Waldorf education </b> and dwell briefly on
                            the <b>Steiner philosophy</b>. It is recommended that both parents are present for the Open Day. <br> <br> Those interested in joining the school are called in for a face to face with the Advaya Management Team on another day.
                            It is compulsory for both parents to be present for this meeting. The admission form is handed over to the parents at the end of this meeting. <br><br> After which, closer to the month of November we meet with the children
                            for an observation to understand the child better. Parents are required to submit the completed admission form on this day. <br> <br> Please note the below age criteria for Admission to Grade 1:

                            <h4>The child should have completed 6 years of age by May 31st </h4>
                    </div>
