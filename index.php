...
<body>
    ...
    <div class="wrapper" id="wrapper">
        ...
        <div class="slide__carosel owl-carousel owl-theme">
            <div class="slider__area bg-pngimage--31  d-flex fullscreen justify-content-start align-items-center">
                <div class="container">
                    <div class="row">
            ...
            <!-- Strat Slider Area -->
            <div class="slide__carosel owl-carousel owl-theme">
                <div class="slider__area bg-pngimage--21  d-flex fullscreen justify-content-start align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="slider__activation">
            ...
            <!-- Strat Slider Area -->
            <div class="slide__carosel owl-carousel owl-theme">
                <div class="slider__area bg-pngimage--41  d-flex fullscreen justify-content-start align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="slider__activation">
            ...
            <!-- Strat Slider Area -->
            <div class="slide__carosel owl-carousel owl-theme">
                <div class="slider__area bg-pngimage--51  d-flex fullscreen justify-content-start align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="slider__activation">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section__title text-center">
                            <h2 class="title__line">Welcome To Advaya Shaale</h2>
                            <article class="dacre__blog__details">
                                <div class="blog__inner">
                                    <blockquote> Recieve the children in reverence, educate them in love, and send them forth in freedom <span><b>Rudolf Steiner</b></span> </blockquote>
                                </div>
                            </article>
                        </div>
                    </div>
                ...
                <div class="row jn__welcome__wrapper align-items-center">
                    <div class="col-md-12 col-lg-6 col-sm-12">
                        <div class="welcome__juniro__inner">
                            <p class="wow flipInX"> Advaya Shaale is founded on the contemporary interpretation of an Indianised version of Steiner Waldorf philosophy. The school aims to foster in children, an intrinsic love for learning that emphasizes goodness, beauty and
                                truth. The school intends to encourage and nourish the highest expression of Willing, Feeling and Thinking in the children, thus enabling them to emerge as conscientious and Harmonious World Citizens.</p>
                            <div class="wel__btn">
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12">
                        <div class="jnr__call__action__wrap d-flex flex-wrap flex-md-nowrap flex-lg-nowrap justify-content-between align-items-center">
                            ...
                            <div class="callto__action__btn">
                                <a class="dcare__btn btn__white" href="contact.php">Contact Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row upcomming__wrap mt--40">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 wow fadeInLeft">
                        <div class="upcomming__event">
                            ...
                            <div class="upcomming__inner">
                                <h6><a href="http://www.advayashaale.org/openday.php">Open Day</a></h6>
                                <p> The open day is an opportunity for interested parents and teachers to come understand the philosophy and practices at our school. </p>
                                <ul class="event__time">
                                    <li><i class="fa fa-home"></i>Advaya Shaale, Bangalore</li>
                                    <li><i class="fa fa-clock-o"></i>9.30 AM to 11.00 AM</li>
                                    <li><i class="fa fa-calendar"></i>14th SEP, 2019</li>
                                </ul>
                            </div>
                            <div class="event__occur">
                                <img src="images/upcomming/shape/1.png" alt="shape images">
                                <div class="enent__pub">
                                    <span class="time">14th </span>
                                    <span class="bate">SEP,2019</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 wow fadeInLeft">
                        <div class="upcomming__event">
                            ...
                            <div class="upcomming__inner">
                                <h6><a href="http://www.advayashaale.org/tarang.php">Tarang 2019</a></h6>
                                <p> Tarang 2019 - An eco-friendly event </p>
                                <ul class="event__time">
                                    <li><i class="fa fa-home"></i>Advaya Shaale, Bangalore</li>
                                    <li><i class="fa fa-clock-o"></i>9:00 AM to 4.00 PM</li>
                                    <li><i class="fa fa-calendar"></i>24th Nov, 2019</li>
                                </ul>
                            </div>
                            <div class="event__occur">
                                <img src="images/upcomming/shape/1.png" alt="shape images">
